...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "w-[346px] rounded-lg border border-gray-100 bg-white",
      className
    )}
    {...props}
  />
  ...
  <div className="p-2.5">
    <div className="relative" cmdk-input-wrapper="">
      ...
      <CommandPrimitive.Input
        ref={ref}
        className={cn(
          "h-11 w-full rounded-[5px] border-gray-300 p-2.5 pl-9 text-xs leading-6 focus:border-primary-300 focus:ring-2 focus:ring-primary-50 ",
          className
        )}
        {...props}
      />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-start gap-x-2.5 rounded-lg py-2 pl-3 pr-[18px] outline-none hover:bg-gray-50",
      className
    )}
    {...props}
  />
